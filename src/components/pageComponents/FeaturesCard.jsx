...
const FeaturesCard = ({ card }) => {
    if (card === 1) {
        return (
            <div style={{ position: 'relative', width: '339px', height: '375px', borderRadius: '12px', backgroundColor: '#fff', boxShadow: '3px 4px 15.2px 0 rgba(0, 0, 0, 0.25)', padding: '0', overflow: 'hidden' }}>
